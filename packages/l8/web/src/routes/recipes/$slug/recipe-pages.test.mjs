...
check('indoor method applies calculated dough formula', indoorFacts.includes('861g Kirkland Organic All-Purpose Flour') && indoorFacts.includes('542g water') && indoorFacts.includes('17.2g oil') && indoorFacts.includes('63% hydration'))
...
check('browser Back restores authored formula', outdoorFacts.includes('861g Kirkland Organic All-Purpose Flour') && outdoorFacts.includes('560g water') && outdoorFacts.includes('2.15g SAF gold instant yeast') && outdoorFacts.includes('17.2g fine sea salt'), outdoorFacts.slice(outdoorFacts.indexOf('Ingredients'), outdoorFacts.indexOf('Instructions')))
await desktop.getByRole('button', { name: 'Adjust Recipe' }).first().click()
