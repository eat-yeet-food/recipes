...
check(
  'palette input focused',
  await page.evaluate(() => document.activeElement?.getAttribute('data-slot') === 'command-input'),
)
...
// The sidebar is `hidden` below lg, so mobile needs a separate affordance.
