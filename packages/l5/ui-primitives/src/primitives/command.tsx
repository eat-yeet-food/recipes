...
function CommandInput({
  ...
  /** Optional trailing content (kbd hints, a Cancel button) inline with the input. */
    ...
    <div data-slot="command-input-wrapper" className={cn("flex items-center px-4", wrapperClassName)}>
      <InputGroup className="h-12 border-0 bg-transparent shadow-none!">
        ...
        <CommandPrimitive.Input
          ...
          {...props}
        />
        {endAddon && <InputGroupAddon align="inline-end" className="p-0">{endAddon}</InputGroupAddon>}
      </InputGroup>
    </div>
  )
}
