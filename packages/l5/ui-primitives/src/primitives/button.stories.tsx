...
const meta = {
  ...
  parameters: { layout: 'padded', docs: { description: { component: 'Choose the action treatment for its context: filled ink with cream labels for primary recipe controls; compact utility actions with thin ink borders for article headers; yellow actions and light quiet labels on ink panels. All retain a 44px default target and inset focus without underlining. Use asChild for navigation links. Outline remains a compatibility alias for secondary; utility owns the thin border.' } } },
