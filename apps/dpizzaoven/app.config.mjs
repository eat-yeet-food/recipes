...
export const app = {
  ...
  copy: {
    ...
    pages: {
      ...
      learnTitle: "Learn | Dave's Pizza Oven",
      learnHeading: 'Learn',
      learnDescription:
        'Technique guides for mixing methods, sourdough strength, final dough temperature, pizza handling, and oven control.',
      learnIntro: 'Practical pizza and baking references for mixing methods, fermentation, handling, and oven control.',
      recipeFallbackTitle: "Recipe | Dave's Pizza Oven",
      recipeTitleSuffix: "Dave's Pizza Oven",
      articleFallbackTitle: "Learn | Dave's Pizza Oven",
      articleTitleSuffix: "Dave's Pizza Oven",
    },
  ...
  previewPaths: ['', 'recipes', 'search', 'browse', 'learn', 'recipes/tavern-style'],
  paths: {
    fixtures: 'apps/dpizzaoven/fixtures/recipes',
    articleFixtures: 'apps/dpizzaoven/fixtures/articles',
