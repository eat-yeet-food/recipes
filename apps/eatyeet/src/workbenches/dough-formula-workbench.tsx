...
const yeastGramPrecision = (value: number): NumberFieldPrecision => Math.abs(value) >= 20 ? 0 : 2
const formatYeastGrams = (value: number) => Number.isFinite(value) ? `${formatNumberFieldValue(value, yeastGramPrecision(value))}g` : '—'
