...
export const app = {
  ...
  copy: {
    ...
    pages: {
      ...
      learnTitle: 'Learn | Eat / Yeet',
      learnHeading: 'Learn',
      learnDescription:
        'A practical guide to mixing methods, gluten development, dough temperature, and choosing the right development target.',
      learnIntro: 'Start with one practical reference for mixing methods, gluten development, dough temperature, and choosing the right development target.',
      recipeFallbackTitle: 'Recipe | Eat / Yeet',
      recipeTitleSuffix: 'Eat / Yeet',
      articleFallbackTitle: 'Learn | Eat / Yeet',
      articleTitleSuffix: 'Eat / Yeet',
    },
    jsonLdAuthor: 'Patrick Hogan',
  },
  staticPaths: ['/', '/recipes', '/browse', '/search', '/learn'],
  sitemapStaticPaths: ['/', '/recipes', '/browse', '/learn'],
  robotsDisallow: ['/search'],
  previewPaths: ['', 'recipes', 'search', 'browse', 'learn', 'learn/mixing-dough-and-gluten-development', 'recipes/new-york-style-pizza'],
  paths: {
